...
export default function Todo(todo: Todo) {
    ...
    return(
        <article className="my-4 flex justify-between items-center" style={{ opacity:!isMutating ? 1 : 0.7}}>
            <label className="text-2xl hover:underline text-black">
            ...
            <div className="flex items-center gap-4">
                ...
                disabled={isPending}
                className="p-3 text-xl rounded-2xl text-black border-solid border-black border-2 max-w-xs hover:cursor-pointer"                
                />
